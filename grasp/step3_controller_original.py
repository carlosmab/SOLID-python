...
class App(tk.Tk):
    ...
    def add_product(self):
        name = str(simpledialog.askstring(title="Add", prompt="Product name:"))
        price = float(str(simpledialog.askstring(title="Add", prompt="Product price:")))
    ...
    def on_focus_out(self, event=None) -> None:
        self.product_list.select_clear(0, tk.END)
